...
public class JoinBbsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		********************************/
		List<JoinBbsVO> list = JoinBbsDAO.getJoinBbsList();
		System.out.println("JoinBbsDAO.getTotalCount() : " + JoinBbsDAO.getTotalCount());

		Paging p = new Paging(5, 5, JoinBbsDAO.getTotalCount());
		...
		request.getRequestDispatcher("join-bbs/join_bbs.jsp").forward(request, response);
	}
